...
export default function FormName() {
  ...
  return (
    <div className='font-base w-full flex-col items-center pt-40'>
      ...
      <div className='bg-light-light text-secondary h-full rounded-md px-7 pb-12 pt-5 text-sm shadow-md lg:text-base'>
        ...
        <input
          ...
          className='border-primary mt-2 h-5 w-full rounded-md border px-2 py-6 text-lg focus:outline-none lg:text-xl'
        />
