...
type UserWithLanguages = {
  id: number;
  name: string | undefined;
  birthdate: Date | undefined;
  gender: Gender | undefined;
  biography: string | undefined;
  account_github: string | undefined;
...
async function getUsers(userId: number) {
  ...
  // MySQL query:
  //
  // SELECT FROM u.name, u.birthdate, u.gender, u.biography, u.account_github, u.city_id
  // FROM user AS u
  // WHERE u.name IS NOT NULL AND u.birthdate IS NOT NULL AND u.gender IS NOT NULL
  // AND u.city_id IS NOT NULL AND activate_at IS NOT NULL
  // AND u.id IN NOT (
