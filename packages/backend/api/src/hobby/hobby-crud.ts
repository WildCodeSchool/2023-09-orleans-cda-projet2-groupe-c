...
hobbyRouter.get('/', async (req, res) => {
  try {
    ...
    let query = db.selectFrom('hobby').selectAll();
    ...
    const hobbies = await query.execute();
...
// GET hobby by id
hobbyRouter.get('/:hobbyId', async (req, res) => {
  try {
...
// // UPDATE hobby
// hobbyRouter.put('/:hobbyId', async (req, res) => {
//   try {
//     const hobbyId = Number.parseInt(req.params.hobbyId);
//     // eslint-disable-next-line @typescript-eslint/naming-convention
//     const { name, hobby_category_id } = req.body;
...
// // DELETE hobby
// hobbyRouter.delete('/:hobbyId', async (req, res) => {
//   try {
//     const hobbyId = Number.parseInt(req.params.hobbyId);
